...
QwertyParser.prototype.arr_assignment = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << QwertyParser.OPEN_PAR) | (1 << QwertyParser.ADD) | (1 << QwertyParser.SUB))) !== 0) || ((((_la - 52)) & ~0x1f) == 0 && ((1 << (_la - 52)) & ((1 << (QwertyParser.INTEGER_LITERAL - 52)) | (1 << (QwertyParser.FLOAT_LITERAL - 52)) | (1 << (QwertyParser.CHAR_LITERAL - 52)))) !== 0)) {
            this.state = 514;
            this.num_expression();
            this.state = 519;
            this._errHandler.sync(this);

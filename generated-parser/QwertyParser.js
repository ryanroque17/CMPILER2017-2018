...
QwertyParser.prototype.var_decl = function() {
    ...
    try {
        ...
        if(_la===QwertyParser.INTEGER_LITERAL) {
            this.state = 135;
            this.array_size();
        }
...
If_statementContext.prototype.conditional_block = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
        return this.getTypedRuleContexts(Conditional_blockContext);
    } else {
        return this.getTypedRuleContext(Conditional_blockContext,i);
    }
};
...
While_statementContext.prototype.conditional_block = function() {
...
For_statementContext.prototype.assignment_statement = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
For_statementContext.prototype.data_type = function() {
    return this.getTypedRuleContext(Data_typeContext,0);
};

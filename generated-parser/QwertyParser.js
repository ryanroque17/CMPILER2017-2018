...
Num_factorContext.prototype.VARIABLE_IDENTIFIER = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
Num_factorContext.prototype.OPEN_BRACKET = function() {
    return this.getToken(QwertyParser.OPEN_BRACKET, 0);
};

Num_factorContext.prototype.CLOSE_BRACKET = function() {
    return this.getToken(QwertyParser.CLOSE_BRACKET, 0);
};
...
Bool_expressionContext.prototype.relational_ope = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
Bool_expressionContext.prototype.logical_ope = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
        return this.getTypedRuleContexts(Logical_opeContext);
    } else {
        return this.getTypedRuleContext(Logical_opeContext,i);
    }
};
            ...
            while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
                if(_alt===1) {
                    ...
                    case QwertyParser.NOTEQUAL:
                        ...
                        this.relational_ope();
                        break;
                    case QwertyParser.AND:
                    case QwertyParser.OR:
                        this.state = 355;
                        this.logical_ope();
                        break;
                    default:
...
Arr_assignmentContext.prototype.num_expression = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
QwertyParser.prototype.arr_assignment = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << QwertyParser.OPEN_PAR) | (1 << QwertyParser.ADD) | (1 << QwertyParser.SUB))) !== 0) || ((((_la - 52)) & ~0x1f) == 0 && ((1 << (_la - 52)) & ((1 << (QwertyParser.INTEGER_LITERAL - 52)) | (1 << (QwertyParser.FLOAT_LITERAL - 52)) | (1 << (QwertyParser.CHAR_LITERAL - 52)) | (1 << (QwertyParser.VARIABLE_IDENTIFIER - 52)))) !== 0)) {
            this.state = 559;
            this.num_expression(0);
            this.state = 564;
            this._errHandler.sync(this);
